            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="hidden" id="id_paciente" name="id_paciente" value="<?php echo $id;?>">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="serv_egreso">Servicio de Egreso</label>
                  <input type="text" class="form-control" id="serv_egreso" name="serv_egreso">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
            ...
            <fieldset class="border row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="servicio_epicrisis" name="servicio_epicrisis">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="medico_ingreso">Médico de Ingreso</label>
                  <input type="text" class="form-control" id="medico_ingreso" name="medico_ingreso">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="fecha_ingreso_epi">Fecha Ingreso</label>
                  <input type="date" class="form-control" id="fecha_ingreso_epi" name="fecha_ingreso_epi">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="por_emergencia" name="por_emergencia">
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="consulta_externa" name="consulta_externa">
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="referido_de" name="referido_de">
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="condicion_ingreso" name="condicion_ingreso">
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="resumen_anamnesi" name="resumen_anamnesi" rows="3"></textarea>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="diagnostico_ingreso" name="diagnostico_ingreso" rows="3"></textarea>
                </div>
              </div>
            ...
            <fieldset class="border row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="emograma" name="emograma">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="reaccion_widal">Reacción Widal</label>
                  <input type="text" class="form-control" id="reaccion_widal" name="reaccion_widal">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="coproparasitolo">Coproparasitolo</label>
                  <input type="text" class="form-control" id="coproparasitolo" name="coproparasitolo">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="examen_orina">Examen de Orina</label>
                  <input type="text" class="form-control" id="examen_orina" name="examen_orina">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="electrolito">Electrolitos</label>
                  <input type="text" class="form-control" id="electrolito" name="electrolito">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="radiografia">Radiografía</label>
                  <input type="text" class="form-control" id="radiografia" name="radiografia">
                </div>
              </div>
            </fieldset>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="diagnostico_sala" name="diagnostico_sala" rows="3"></textarea>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="tratamiento_recibido">Tratamiento Recibido</label>
                  <textarea class="form-control" id="tratamiento_recibido" name="tratamiento_recibido" rows="3"></textarea>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="evaluacion_servicio" name="evaluacion_servicio">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="complicaciones">Complicaciones</label>
                  <input type="text" class="form-control" id="complicaciones" name="complicaciones">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="diagnostico_egreso" name="diagnostico_egreso">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="diagnostico_egreso">Fecha de egreso</label>
                  <input type="date" class="form-control" id="fecha_egreso_epi" name="fecha_egreso_epi">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="tratamiento_ambulatorio" name="tratamiento_ambulatorio" rows="3"></textarea>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="condicion_egreso" name="condicion_egreso">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="matricula_medico" name="matricula_medico">
                </div>
              </div>
            </div>
